...
def get_quotes(y,m,d, slow, fast, stock):
    ...
    if slow_trend >= 0.2 and fast_trend >= 0.2:
        ...
        cat = 'Mean Reverting'
    # print(stock, y, fast_trend, slow_trend, cat, close_slow_std, close__fast_std, slow_ma_std, fasts_ma_std, '\n') 
    print(stock, y, fast_trend, slow_trend, cat,'\n') 
...
#-------------
    ...
    # ax3.legend(('Close Slow', 'Close Fast', 'Slow Std', 'Fast Std')) # dont know why but legends need 2 sets of parenthesis
